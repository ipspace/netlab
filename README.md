...
The latest release is [release 1.6.3](https://github.com/ipspace/netlab/releases/tag/release_1.6.3); if you prefer an older one, use release 1.5.4. You might also want to [read the release notes](https://netlab.tools/release/).
<!--
