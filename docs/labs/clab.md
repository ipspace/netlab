...
* Build the BIRD, dnsmasq, VPP, and Netscaler images with the **netlab clab build** command. BIRD and VPP support configurable software releases — see [](build-bird) and [](build-vpp) for details.
