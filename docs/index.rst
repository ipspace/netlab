...
**initial-config.ansible**
  Configures common device parameters using topology data generated by **create-topology** and default device configuration templates. Configured parameters include hostname, LLDP, interface admin state, and MAC and IP addresses.
