...
**initial-config.ansible**
  Configures common device parameters using topology data generated by **create-topology** and default device configuration templates. Configured parameters include hostname, LLDP, interface admin state, and MAC and IP addresses. :doc:`More details <configs>`

**config.ansible**
  Applies Jinja2 configuration template to network devices. Includes support for platform-specific configuration templates.
