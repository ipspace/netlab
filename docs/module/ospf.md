...
* **ospf.timers** -- set OSPF interface timers. A dictionary containing **dead** and **hello** values (from 1 to 8192 seconds). If you specify only one of the timers, the other one is set to be four times higher/lower.
