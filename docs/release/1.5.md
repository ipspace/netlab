...
* New **[netlab report](../netlab/report.md)** command generates built-in or user-defined text- or HTML reports based on transformed lab topology.
* New **[netlab graph](../netlab/graph.md)** command generates [topology graph descriptions](../outputs/graph.md) in GraphViz or D2 format
* New **[netlab inspect](../netlab/report.md)** command displays data structures in transformed lab topology
